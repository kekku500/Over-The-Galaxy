...
public class DialogueBox extends AbstractComponent{
	...
	public DialogueBox(){
	setPosition(Game.width-width,Game.height-height);
	...
	public void addText(String tekst){
		String[] lõigutud = Stringcutter.cut(tekst, 30);
	...
	public Entity setLink(Entity t) {
		if(t instanceof DialogueBox){
			DialogueBox wt = (DialogueBox)t;			
		}
		return this;
	}
	...
	public Entity getLinked() {
		return new DialogueBox().setLink(this);
	}
