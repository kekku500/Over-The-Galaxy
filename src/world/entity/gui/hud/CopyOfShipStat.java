...
public class CopyOfShipStat extends AbstractComponent {
	...
	public CopyOfShipStat(Player player){
		this.player = player;
	...
	public Entity setLink(Entity t) {
		if(t instanceof CopyOfShipStat){
			CopyOfShipStat wt = (CopyOfShipStat)t;			
		}
		return this;
	}
	...
	//	return new HudComponent(getPosition().x, getPosition().y).setLink(this);
		return new CopyOfShipStat(player).setLink(this);
	}
