...
*/
    public static Texture loadTexture(String name)
    {
        ...
        {	
          ...
          bimg = ImageIO.read(new File("D:\\Programming\\eclipse\\workspaces\\java\\github\\Over-The-Galaxy\\src\\resources\\" + name));//Texture.class.getClassLoader().getResourceAsStream(name));
